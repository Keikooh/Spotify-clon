...
import TracksTopResults from "@components/TracksTopResults";
...
const AllResults = () => {
  ...
  useEffect(() => {
    console.log({albums: filtered.albums})
  }, [filtered.albums])
      ...
      <div className="flex ">
        ...
        <div className="p-2 w-1/3 flex flex-col gap-2">
          ...
          <div className="group relative p-5 bg-gray-900 hover:bg-gray-700 transition duration-150 rounded-lg h-full cursor-pointer">
            <img className="size-24 rounded-lg mb-3 shadow-2xl" src={"/images/placeholder.png"} />
        ...
        <div className="p-2 w-2/3 flex flex-col gap-2">
          ...
          <TracksTopResults tracks={filtered.tracks.slice(0,4)}/>
        </div>
      </div>
